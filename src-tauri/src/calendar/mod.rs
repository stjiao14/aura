...
///
/// On macOS this reads from EventKit via the Swift layer.
/// On other platforms calendar integration is not yet implemented and an
/// empty list is returned.
///
/// Blocks on a semaphore internally on macOS — call via `spawn_blocking`.
#[cfg(target_os = "macos")]
...
/// Calendar integration is not yet implemented on this platform.
